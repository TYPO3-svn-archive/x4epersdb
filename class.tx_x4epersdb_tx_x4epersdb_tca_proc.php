...
class tx_x4epersdb_tx_x4epersdb_tca_proc {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/x4epersdb/class.tx_x4epersdb_tx_x4epersdb_tca_proc.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/x4epersdb/class.tx_x4epersdb_tx_x4epersdb_tca_proc.php']);
}
